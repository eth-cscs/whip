...
function(whip_add_type var wrapper wrapped)
  ...
  if("${WHIP_TYPE}" STREQUAL "CUDA" AND NOT "${whip_add_type_CUDA_OVERRIDE}" STREQUAL "")
    set(wrapped "${whip_add_type_CUDA_OVERRIDE}")
  elseif("${WHIP_TYPE}" STREQUAL "HIP" AND NOT "${whip_add_type_HIP_OVERRIDE}" STREQUAL "")
    set(wrapped "${whip_add_type_HIP_OVERRIDE}")
  endif()

  set(type "using ${wrapper} = ${whip_wrapped_prefix}${wrapped};")
  set(${var} "${${var}}\n${type}" PARENT_SCOPE)
endfunction()
...
function(whip_add_function var wrapper params wrapped)
  ...
  if("${WHIP_TYPE}" STREQUAL "CUDA" AND NOT "${whip_add_function_CUDA_OVERRIDE}" STREQUAL "")
    set(wrapped "${whip_add_function_CUDA_OVERRIDE}")
  elseif("${WHIP_TYPE}" STREQUAL "HIP" AND NOT "${whip_add_function_HIP_OVERRIDE}" STREQUAL "")
    set(wrapped "${whip_add_function_HIP_OVERRIDE}")
  endif()
  ...
  set(wrapped_call "${whip_wrapped_prefix}${wrapped}(${wrapped_call_args})")

  set(checker "impl::check_error")
  if(whip_add_function_QUERY)
    set(checker "impl::check_error_query")
  endif()
  set(fun "inline auto ${wrapper} = [](${wrapper_definition_params}) { return ${checker}(${wrapped_call}); };")
  set(${var} "${${var}}\n${fun}" PARENT_SCOPE)
endfunction()

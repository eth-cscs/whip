...
function(hwh_add_function var wrapper params wrapped)
  ...
  set(fun "inline void ${wrapper}(${wrapper_definition_params}) { check_error(${wrapped_call}); }")
  if(hwh_add_function_LAMBDA)
    set(fun "inline auto ${wrapper} = [](${wrapper_definition_params}) -> void { check_error(${wrapped_call}); };")
  endif()
  set(${var} "${${var}}\n${fun}" PARENT_SCOPE)
endfunction()
